...
use App\Models\EcologyCreaditsDay;//日全网新增业绩结算表
use App\Models\EcologyCreaditsDayFushu;//日全网新增业绩结算附属表
use App\Models\EcologyCreadits;//生态2积分余额表
use App\Models\EcologyCreaditsLog;//生态2积分余额日志表
use App\Models\EcologyCreaditsOrders;//生态2积分订单表
...
class EcologySettlement
{
    ...
    public function __construct()
    {
        ...
        $this->ecdModel = new EcologyCreaditsDay;//日全网新增业绩结算表
        $this->ecdfModel = new EcologyCreaditsDayFushu;//日全网新增业绩结算附属表
        $this->ecModel = new EcologyCreadits;//生态2积分余额表
        $this->eclModel = new EcologyCreaditsLog;//生态2积分余额日志表
        $this->ecoModel = new EcologyCreaditsOrders;//生态2积分订单表
